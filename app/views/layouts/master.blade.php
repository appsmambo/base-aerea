...
<html lang="es">
	<head>
		...
		<title>{{$titulo}}Gestor de recursos</title>
		...
		<link type="text/css" rel="stylesheet" href="{{url('bower_components/morrisjs/morris.css')}}">
		<link type="text/css" rel="stylesheet" href="{{url('bower_components/font-awesome/css/font-awesome.min.css')}}">
		<link type="text/css" rel="stylesheet" href="{{url('css/timeline.css')}}">
